    ...
    <AuthenticationCard>
        ...
        <form @submit.prevent="submit">
            ...
            <div>
                ...
                <TextInput id="firstname" v-model="form.firstname" type="text" class="mt-1 block w-full" required autofocus
            ...
            <div>
                ...
                <TextInput id="lastname" v-model="form.lastname" type="text" class="mt-1 block w-full" required autofocus
            ...
            <div class="mt-4">
                ...
                <TextInput id="text" v-model="form.tel" type="email" class="mt-1 block w-full" required
                    autocomplete="username" />
